...
config :test_assignment, TestAssignmentWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "WFw2TmEUek2RMlwYC1gZYL33oFpi03kjuMQjWfveV8Hv9a97n/Rx3y8EOx1zxjYg",
  watchers: [
...
config :test_assignment, TestAssignmentWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/test_assignment_web/(live|views)/.*(ex)$",
      ~r"lib/test_assignment_web/templates/.*(eex)$"
    ]
  ]
